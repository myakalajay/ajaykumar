      ...
      <nav className={`fixed top-1 left-0 right-0 z-[1000] transition-all duration-500 border-b ${isScrolled ? 'bg-black/90 backdrop-blur-xl border-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.8)]' : 'bg-transparent border-transparent'}`}>
        <div className="max-w-[1800px] mx-auto px-6 md:px-12 xl:px-24 h-20 flex items-center justify-between">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, ease: CUSTOM_EASE }} className="hidden lg:flex items-center gap-6">
            ...
            {/* VERCEL TRACKING INJECTED HERE */}
            <a 
              href="/Ajay_Kumar_Myakala_Designer.pdf" 
              target="_blank" 
              rel="noopener noreferrer" 
              onClick={() => track('Downloaded_Desktop_Resume')}
              className="flex items-center gap-2 text-[10px] uppercase tracking-[0.2em] font-bold transition-colors hover:text-[#bef264] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#bef264] rounded-sm py-1" 
              style={{ color: THEME.muted, fontFamily: THEME.fonts.body }}
            >
            ...
            <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }} transition={{ duration: 0.4, ease: CUSTOM_EASE }} className="lg:hidden overflow-hidden bg-black/95 backdrop-blur-3xl border-b border-white/10">
              <div className="flex flex-col px-6 py-8 gap-6">
                ...
                <div className="flex flex-col gap-6 pt-4">
                  ...
                  {/* VERCEL TRACKING INJECTED HERE */}
                  <a 
                    href="/Ajay_Kumar_Myakala_Product_Designer.pdf" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    onClick={() => track('Downloaded_Mobile_Resume')}
                    className="flex items-center gap-2 text-xs uppercase tracking-[0.2em] font-bold text-white/70 hover:text-[#bef264] transition-colors"
                  >
...
const Hero = () => {
  ...
  const scrollToSection = (e: React.MouseEvent<HTMLButtonElement>, target: string) => {
    e.preventDefault();
      ...
      <div className="w-full mx-auto px-4 md:px-8 relative z-20 flex flex-col items-center mt-10">
        ...
        <div className="flex flex-wrap justify-center items-center gap-4 mb-8 md:mb-12">
          <motion.div whileHover={{ scale: 1.05 }} transition={{ type: "spring", stiffness: 400, damping: 10 }} className="flex items-center gap-3 px-5 py-2.5 border border-[#bef264]/60 rounded-full bg-[#bef264]/10 backdrop-blur-md shadow-[0_0_20px_rgba(190,242,100,0.2)]">
            ...
            <span className="text-[10px] uppercase tracking-[0.2em] font-bold" style={{ fontFamily: THEME.fonts.mono, color: THEME.primary }}>
              10 Yrs UX & Product Design
            </span>
          </motion.div>
          <motion.div whileHover={{ scale: 1.05 }} transition={{ type: "spring", stiffness: 400, damping: 10 }} className="hidden sm:flex items-center gap-2 px-5 py-2.5 border border-white/20 bg-black/80 backdrop-blur-md rounded-full shadow-2xl relative overflow-hidden group">
            ...
            <span className="text-[10px] uppercase tracking-widest font-bold text-white/70 group-hover:text-white transition-colors" style={{ fontFamily: THEME.fonts.mono }}>
        ...
        >
          ...
          <h1 className="flex flex-col items-center w-full text-center leading-[0.85] tracking-tighter uppercase font-bold select-none" style={{ fontFamily: THEME.fonts.display }}>
            ...
            {/* LINE 1 */}
            <motion.span initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.1, ease: CUSTOM_EASE }} className="text-white drop-shadow-2xl text-[clamp(3rem,10vw,11rem)] translate-z-[40px]">
              ENTERPRISE
            </motion.span>
            ...
            <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2, ease: CUSTOM_EASE }} className="relative w-full flex justify-center translate-z-[60px]">
              <span className="text-transparent text-[clamp(3rem,11vw,12rem)] relative z-10 drop-shadow-[0_0_30px_rgba(255,255,255,0.1)]" style={{ WebkitTextStroke: '2px rgba(255,255,255,0.3)' }}>
                PRODUCT DESIGN
              </span>
            ...
            {/* LINE 3 */}
            <motion.span initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.3, ease: CUSTOM_EASE }} className="text-transparent bg-clip-text relative mt-2 md:mt-4 text-[clamp(3rem,9vw,11rem)] translate-z-[80px]" style={{ backgroundImage: `linear-gradient(to right, #ffffff, ${THEME.primary}, #ffffff)`, backgroundSize: '200% auto', animation: 'shine 6s linear infinite' }}>
              & SCALABLE SYSTEMS.
            </motion.span>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 0.5 }} className="max-w-2xl mx-auto space-y-10 mt-12 md:mt-16 relative z-20">
          <p className="text-base md:text-xl font-light leading-relaxed text-white/70 text-balance text-center" style={{ fontFamily: THEME.fonts.body }}>
            Designing complex B2B ecosystems, FinTech platforms, and modernizing legacy ERPs (SAP) into scalable React-based interfaces. I leverage <strong className="text-white font-medium">WCAG 2.2 accessibility standards and SAP Fiori guidelines</strong> to bridge the gap between product strategy and engineering execution.
          </p>
          <div className="flex flex-wrap justify-center gap-2 md:gap-3">
            {[ 
              { label: "B2B SaaS Workflows", icon: <Terminal className="w-3 h-3" /> }, 
              { label: "SAP Fiori Standards", icon: <Database className="w-3 h-3" /> }, 
              { label: "WCAG 2.2 Accessibility", icon: <ShieldCheck className="w-3 h-3" /> } 
            ].map((pill, i) => (
        ...
        {/* TIERED COMMAND NODES */}
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.7 }} className="mt-14 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 w-full relative z-30 px-6">
          <button onClick={(e: React.MouseEvent<HTMLButtonElement>) => scrollToSection(e, "#work")} className="flex items-center justify-center w-full sm:w-auto rounded-sm h-14 px-10 text-black hover:bg-white text-[10px] font-bold uppercase border-none hover:scale-[1.02] shadow-[0_0_40px_rgba(190,242,100,0.3)] transition-all" style={{ backgroundColor: THEME.primary, fontFamily: THEME.fonts.mono }}>
            Examine Case Studies
          </button>

          <a 
            href="/Ajay_Kumar_Senior_Product_Designer_Cv.pdf" 
            download 
            className="group flex items-center justify-center gap-3 w-full sm:w-auto h-14 px-8 text-[10px] uppercase tracking-widest font-bold border border-white/20 hover:border-[#bef264] text-white hover:text-[#bef264] transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#bef264] rounded-sm bg-black/50 backdrop-blur-md shadow-lg hover:shadow-[0_0_20px_rgba(190,242,100,0.15)]" 
          ...
          <button onClick={(e: React.MouseEvent<HTMLButtonElement>) => scrollToSection(e, "#contact")} className="group flex items-center justify-center gap-3 w-full sm:w-auto h-14 px-4 mt-2 sm:mt-0 text-[10px] uppercase tracking-widest font-bold text-white/40 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white rounded-sm" style={{ fontFamily: THEME.fonts.mono }}>
            Initialize Comm <ArrowRight className="w-4 h-4 opacity-50 group-hover:translate-x-1 group-hover:opacity-100 transition-all" />
          </button>
        </motion.div>
      </div>
...
const Experience = () => {
  ...
  // Data Array: Original Designations with Architect-Level Descriptions
  const experiences = [
    { 
      phase: "Phase III: Enterprise Architecture", 
      role: "Sr Product Designer", 
      context: "Digital Mortgage Ecosystem", 
      company: "Homeloc Solutions LLP", 
      dates: "Mar 2024 - Mar 2026",
      domain: "FinTech & Compliance", 
      duration: "2 Yrs", 
      desc: "Architected a zero-to-one B2B ecosystem. Engineered a SOC 2 compliant progressive disclosure pipeline and leveraged AI (LLMs) to parse complex financial APIs.",
      isRecent: true
    },
    { 
      phase: "Phase III: Enterprise Architecture", 
      role: "Sr UI/UX Designer", 
      context: "B2B ESG & Supply Chain", 
      company: "Computech Business Solutions", 
      dates: "Mar 2023 - Mar 2024", 
      duration: "1 Yr 1 Mo",
      domain: "B2B SaaS & SAP Fiori", 
      desc: "Directed UI architecture strictly aligned with SAP Fiori Horizon. Built a tokenized React SPA and implemented strict 'Maker-Checker' financial compliance protocols.",
      isRecent: true
    },
    { 
      phase: "Phase II: Scale & Governance", 
      role: "Sr UI/UX Designer", 
      context: "GovTech Service Portals", 
      company: "Visual IT Solutions", 
      dates: "Sep 2022 - Mar 2023", 
      duration: "7 Mos",
      domain: "Public Governance", 
      desc: "Directed UX architecture for high-scale civic portals. Restructured legacy administrative dashboards into streamlined hubs enforcing strict WCAG 2.2 AA standards." 
    },
    { 
      phase: "Phase II: Scale & Governance", 
      role: "Sr UI/UX Designer", 
      context: "Large-Scale Enterprise", 
      company: "Gaian Solutions", 
      dates: "Oct 2021 - Aug 2022",
      domain: "Enterprise Ecosystems", 
      duration: "11 Mos", 
      desc: "Architected scalable B2B platforms, decoupling rigid legacy data structures into intuitive interfaces. Governed UX patterns to mitigate strict data privacy risks." 
    },
    { 
      phase: "Phase I: Foundation", 
      role: "UI/UX Designer", 
      context: "Hyper-Local News Platform", 
      company: "Way2news Interactive", 
      dates: "May 2018 - Jun 2021", 
      duration: "3 Yrs 2 Mos", 
      domain: "High-Scale Consumer",
      desc: "Engineered UX for India's highest-scaling news platform. Designed a vernacular-first algorithmic discovery loop managing massive data payloads to mitigate banner blindness." 
    },
    { 
      phase: "Phase I: Foundation", 
      role: "UI/UX Designer", 
      context: "Scalable Job Portal", 
      company: "Nitya Software Solutions", 
      dates: "Jan 2016 - May 2018", 
      duration: "2 Yrs 5 Mos", 
      domain: "Recruitment & Talent",
      desc: "Architected a scalable B2B job ecosystem. Engineered advanced data filtering architectures, directly driving a 34% decrease in candidate funnel drop-off rates." 
    }
  ];
...
const CaseStudyContent = ({ project }: { project: any }) => {
  return (
    <article className="pb-24 text-white overflow-x-hidden bg-[#000000] selection:bg-[#bef264] selection:text-black" style={{ fontFamily: THEME.fonts.body }}>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4 md:gap-6 pt-8">
               <div className="bg-[#0a0a0a] p-6 rounded-xl border border-white/10 shadow-lg flex flex-col justify-center">
               ...
               <div className="bg-gradient-to-br from-[#bef264]/10 to-transparent p-6 rounded-xl border border-[#bef264]/30 shadow-[0_0_30px_rgba(190,242,100,0.05)] flex flex-col justify-center">
          ...
          <div className="lg:col-span-5 bg-[#050505] border border-white/10 rounded-2xl p-6 md:p-8 shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4">
                {project.metricsTable.map((row: any, i: number) => (
          ...
          <div className="w-full bg-[#050505] border border-white/10 rounded-2xl shadow-2xl p-6 md:p-12 overflow-x-auto custom-scrollbar">
            <div className="min-w-[1000px] flex items-center justify-between">
              ...
              <div className="relative z-10 w-[280px] bg-[#0a0a0a] border border-white/10 rounded-xl p-6 shrink-0 shadow-lg">
                ...
                <div className="space-y-3">
                  {project.systemArchitecture.client.map((node: any, i: number) => (
              ...
              <div className="relative z-10 w-[320px] bg-black border-2 rounded-xl p-8 shadow-[0_0_40px_rgba(190,242,100,0.1)] shrink-0" style={{ borderColor: `${THEME.primary}40` }}>
                ...
                <div className="space-y-3">
                  {project.systemArchitecture.gateway.map((node: any, i: number) => (
              ...
              <div className="relative z-10 w-[280px] bg-[#0a0a0a] border border-white/10 rounded-xl p-6 shrink-0 shadow-lg">
                ...
                <div className="space-y-3">
                  {project.systemArchitecture.backend.map((node: any, i: number) => (
                    <div key={i} className="flex justify-between items-center px-3 py-2 bg-black border border-white/5 rounded-md text-[9px] hover:border-white/20 transition-colors">
                      <span className="font-mono text-white/80">{node.name}</span>
                      <span className="uppercase font-bold text-[#bef264]/70">{node.type}</span>
                    </div>
          ...
          <div className="grid lg:grid-cols-[1fr_350px] gap-8 items-center bg-[#050505] border border-white/10 rounded-2xl p-6 md:p-10 shadow-2xl">
              ...
              <ResponsiveContainer width="100%" height="100%">
                <ScatterChart margin={{ top: 20, right: 20, bottom: 30, left: 30 }}>
                  ...
                  <Scatter name="Market Entities" data={project.competitorAnalysis.data}>
                    {project.competitorAnalysis.data.map((entry: any, index: number) => (
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                {project.competitorAnalysis.insights.map((insight: string, i: number) => (
      ...
      {project.personas && (
        <section className="max-w-[1400px] mx-auto px-6 space-y-10 border-t border-white/5 pt-20 mt-20">
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-2 gap-8">
            {project.personas.map((persona: any, i: number) => (
                      ...
                      <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={persona.pains} layout="vertical" margin={{ top: 0, right: 0, left: 0, bottom: 0 }}>
                          ...
                          <Bar dataKey="severity" radius={[0, 4, 4, 0]} barSize={16}>
                            {persona.pains.map((entry: any, index: number) => (
               ...
               <div className="min-w-[900px] h-[250px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={project.journeyMap.data} margin={{ top: 10, right: 40, left: 40, bottom: 0 }}>
                      ...
                      <Tooltip cursor={{ stroke: 'rgba(255,255,255,0.2)', strokeWidth: 1, strokeDasharray: '4 4' }} />
               ...
               <div className="min-w-[900px] mt-6 border-t border-white/10">
                  <div className="flex group/row hover:bg-white/[0.02] transition-colors">
                    ...
                    <div className="flex-1 flex justify-between px-6 py-4">
                      {project.journeyMap.data.map((step: any, idx: number) => (
      ...
      {/* 8. INCIDENT POST-MORTEM (Graveyard) */}
      {project.graveyard && project.graveyard.length > 0 && (
        <section className="max-w-[1400px] mx-auto px-6 space-y-10 border-t border-white/5 pt-20 mt-20">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {project.graveyard.map((tomb: any, i: number) => (
              <motion.div 
                key={i} 
            ...
            <div className="bg-[#050505] border border-white/10 rounded-2xl overflow-x-auto custom-scrollbar relative z-0 shadow-2xl">
              <table className="w-full text-left border-collapse min-w-[900px]">
                ...
                <tbody className="divide-y divide-white/5">
                  {project.featureMatrix.map((row: any, i: number) => (
      ...
      {project.accessibility && project.accessibility.length > 0 && (
        <section className="max-w-[1400px] mx-auto px-6 space-y-12 border-t border-white/5 pt-20 mt-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
             {project.accessibility.map((acc: any, i: number) => (
            ...
            <TabsContent value="hifi">
              {project.desktopMockups && project.desktopMockups.length > 0 && (
                <div className="space-y-24">
                  {project.desktopMockups?.map((img: string, i: number) => (
                    <motion.div key={i} initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.8 }} className="relative mx-auto max-w-[1200px]">
              ...
              {project.mobileMocks && project.mobileMocks.length > 0 && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pt-20 max-w-6xl mx-auto">
                  {project.mobileMocks.map((img: string, i: number) => (
...
const Projects = () => {
  ...
  const projectsData = [
    {
      id: "01",
      title: "Regulated B2B Partner Ecosystem",
      tag: "Dealer Portals / Identity Governance",
      role: "Digital & CX Architect", // UPGRADED TITLE
      ...
      heroTitle: "Scaling Partner Efficiency",
      heroSubtitle: "Zero-to-One B2B Architecture",
      
      meta: { 
        role: "Digital & CX Architect", // UPGRADED TITLE
        team: "1 PM, 3 React Engineers, Compliance Ops", 
        duration: "24 Months", 
        platform: "Responsive Web & Native iOS" 
      },
      outcomeVsOutput: { 
        output: "AI-Parsed Payload & SOC 2 Workflows", // UPGRADED HOOK
        outcome: "Decoupled authentication, reducing dealer/partner drop-off by 18%." 
      },
      executiveSummary: "Architected a complex digital ecosystem serving B2B lenders, dealers, and operations. Decoupled platform exploration from strict authentication using a progressive disclosure pipeline grounded in enterprise SOC 2 compliance. Leveraged LLMs to map complex financial logic prior to high-fidelity design execution.", // AI INJECTED
      impactTrend: [
        { name: 'Jan', value: 10 }, { name: 'Feb', value: 25 }, { name: 'Mar', value: 45 }, 
        { name: 'Apr', value: 80 }, { name: 'May', value: 120 }, { name: 'Jun', value: 210 }
      ],
      metricsTable: [
        { metric: "Partner Drop-Off", before: "45%", after: "27%", change: "-18%", positive: true },
        { metric: "Engineering Velocity", before: "Manual", after: "Tokenized", change: "10x", positive: true }
      ],
      testimonials: [
        { quote: "The progressive disclosure model completely bypassed the user anxiety we've battled for years. Quality of B2B leads is up significantly.", author: "Director of Operations", role: "Enterprise Stakeholder" },
      ...
      featureMatrix: [
        ...
        { feature: "AI Data Structuring", requestedBy: "UX Architecture", status: "Delivered", rationale: "Used Claude 3.5 to parse unstructured financial API data into JSON logic for the UI." }, // AI FEATURE ADDED
        { feature: "Third-Party API Integration", requestedBy: "Product", status: "Optional", rationale: "High engineering effort; deferred to post-launch optimization." }
      ],
      accessibility: [
        { standard: "WCAG 2.2 AA Contrast", implementation: "Ensured all tabular data passes strict 4.5:1 contrast ratios against deep black backgrounds." },
        { standard: "Keyboard Navigation", implementation: "Complex modeling sliders mapped to arrow keys for full non-mouse operability in enterprise environments." },
      ...
      graveyard: [
        { title: "The Hard Data-Wall", hypothesis: "Forcing verification before showing platform value will capture higher intent partners.", reasonForFailure: "It caused an immediate 82% bounce rate in staging. Users refused to provide PII without seeing value first. Pivoted to an unauthenticated Guest State." }
      ],
      errorAudit: {
        insight: "By auditing the staging environment, we identified that dynamic slider logic was failing on Safari mobile, preventing 15% of users from completing the workflow. Fixed prior to V1 launch.",
        data: [
      ...
      problemSolution: {
        problem: "Legacy portals rely on predatory data harvesting, forcing partners behind hard PII walls before delivering value. This generates severe cognitive friction.",
        friction: "Mandatory enterprise verification before providing any real-time system data.",
        solution: "A zero-to-one architectural rebuild decoupling exploration from strict authentication. Engineered a progressive disclosure pipeline grounded in SOC 2 compliance.",
        flow: "Value First (Data Graphs) → Soft Pull Estimate → Identity Finalization."
      },
      competitorAnalysis: {
        data: [
          { name: "Legacy Competitor A", uxScore: 4, trustScore: 2, size: 200, fill: "#ffffff" }, 
          { name: "Closed Network B", uxScore: 8, trustScore: 7, size: 200, fill: "#a3a3a3" }, 
          { name: "Homeloc Ecosystem", uxScore: 9, trustScore: 9, size: 400, fill: "#bef264" } 
        ],
        insights: [
          "Legacy competitors aggressively harvest data, causing extreme partner anxiety.",
          "Closed ecosystems offer clean UI but limit operational transparency.",
          "Our architecture positions itself in the high-trust, open-marketplace quadrant via progressive disclosure."
        ]
      },
      personas: [
        { 
          name: "B2B Partner", role: "External User", goals: ["Explore capabilities safely", "Find trustworthy operations"], 
          pains: [{label: "Data Fear", severity: 9}, {label: "Spam Outreach", severity: 10}, {label: "Jargon", severity: 7}], 
          avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=200&auto=format&fit=crop",
          stats: [{ subject: 'Domain Lit', A: 40, fullMark: 100 }, { subject: 'Tech Savvy', A: 80, fullMark: 100 }, { subject: 'Patience', A: 20, fullMark: 100 }, { subject: 'Privacy', A: 95, fullMark: 100 }]
        },
        { 
          name: "Licensed Pro", role: "Enterprise User", goals: ["Acquire high-intent partners", "Reduce manual data entry"], 
          pains: [{label: "Garbage Leads", severity: 9}, {label: "Bad Tools", severity: 8}, {label: "High Cost", severity: 6}], 
          avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=200&auto=format&fit=crop",
          stats: [{ subject: 'Domain Lit', A: 95, fullMark: 100 }, { subject: 'Tech Savvy', A: 60, fullMark: 100 }, { subject: 'Patience', A: 40, fullMark: 100 }, { subject: 'Privacy', A: 60, fullMark: 100 }]
        }
      ],
      journeyMap: {
        data: [
          { step: "Landing", emotion: 2, action: "Views Value Prop", pain: "Skeptical of claims.", system: "CDN Load" },
          { step: "Exploration", emotion: 6, action: "Explores system", pain: "Confused by jargon.", system: "API Fetch" },
          { step: "Modeler", emotion: 8, action: "Plays with data", pain: "None.", system: "React State" },
          { step: "Auth Req", emotion: -8, action: "Hits Identity Wall", pain: "Privacy anxiety.", system: "Auth Gateway" },
          { step: "Trust", emotion: 4, action: "Reads Soft-Pull", pain: "Hesitant but proceeds.", system: "Token Gen" },
          { step: "Success", emotion: 9, action: "Views Dashboard", pain: "Relief.", system: "Cosmos DB Write" }
        ]
      },
      systemArchitecture: {
        client: [{name: "Tokenized UI Grid", type: "React"}, {name: "Affordability Calculators", type: "JS logic"}],
        gateway: [{name: "Identity Encryption", type: "Azure"}, {name: "Data Aggregator", type: "API REST"}],
        backend: [{name: "CRM Sync", type: "Webhooks"}, {name: "SOC 2 Logging", type: "Cosmos DB"}]
      },
      conclusion: { 
        summary: "Acted as a core strategic partner across product and engineering squads. Successfully shipped the V1 architecture to production and formally transitioned the tokenized design system to the internal frontend team. Engineered an ecosystem that filters high-intent partners without resorting to forced data harvesting."
      },
      styleGuide: { 
        description: "Clinical, high-trust aesthetic prioritizing data legibility and strict SOC 2 regulatory security environments.",
    ...
    {
      id: "02",
      title: "DiversityTrax Supplier Platform",
      tag: "B2B Enterprise / SAP Fiori",
      role: "Enterprise UX Architect", // UPGRADED TITLE
      context: "Fortune 500 Enterprise",
      ...
      heroTitle: "Enterprise Supply Chain Analytics",
      heroSubtitle: "Supplier Diversity Ecosystem",
      
      meta: { 
        role: "Enterprise UX Architect", // UPGRADED TITLE
        team: "1 PM, 4 Frontend (React), 2 Backend, 1 BA", 
        duration: "12 Months", 
        platform: "Desktop Web (React SPA / Fiori)"
      },
      outcomeVsOutput: { 
        output: "SAP Fiori Figma Component Library & React SPA", 
        outcome: "63% reduction in supplier reporting time." 
      },
      executiveSummary: "Architected a zero-to-one B2B supplier platform and ESG analytics portal. Transformed fragmented legacy SAP HANA databases into a harmonized, tokenized React SPA following strict SAP Fiori Horizon guidelines.",
      impactTrend: [
        { name: 'Q1', value: 50 }, { name: 'Q2', value: 55 }, { name: 'Q3', value: 75 }, { name: 'Q4', value: 95 }
      ],
      metricsTable: [
        ...
        { metric: "Component Reusability", before: "10%", after: "95%", change: "+85%", positive: true }
      ],
      
      testimonials: [
        { quote: "Ajay's extensive experience bridging product design with frontend tokenized systems is highly impressive. He seamlessly adapts to complex SAP architectural constraints.", author: "Ashish Chenana", role: "Tech Lead" },
        { quote: "Collaborating with Ajay was a masterclass in out-of-the-box thinking. He operates with the strategic depth of a Business Analyst and the execution of an Architect.", author: "Gopi Krishna", role: "Senior Business Analyst" }
      ],
      
      featureMatrix: [
        { feature: "Custom ESG Formula Builder", requestedBy: "Finance Analysts", status: "Optional", rationale: "Too much engineering overhead for MVP. Delayed to V2." },
        { feature: "1-Click PDF Export", requestedBy: "Compliance", status: "Delivered", rationale: "Critical for end-of-year ESG compliance workflows." },
      ...
      accessibility: [
        { standard: "SAP Fiori WCAG 2.2 AA", implementation: "Enforced Fiori's high-contrast theme requirements for all tabular data grids and reporting charts." },
        { standard: "Keyboard Focus Management", implementation: "Ensured seamless Tab-navigation across complex Data Grids and Object Pages to meet enterprise compliance." }
      ],
      
      graveyard: [
        { title: "Legacy Data Migration", hypothesis: "Users will manually migrate historical data using the new bulk CSV uploader tool we designed.", reasonForFailure: "The UI timed out parsing 50,000+ rows of legacy formatting. We had to pivot and engineer an OData API layer to pull directly from SAP HANA instead." }
      ],
      
      problemSolution: {
        problem: "Enterprise users were forced to navigate disjointed, legacy SAP GUI transactions (T-Codes) to pull reports, resulting in high error rates, cognitive overload, and horizontal scroll fatigue.",
        friction: "Inconsistent UI patterns across different legacy database modules caused extreme navigation fatigue.",
        solution: "Engineered a unified UI architecture utilizing the SAP Fiori Design Paradigm. We mapped complex data relationships into intuitive Master-Detail and Object Page layouts within a single SPA.",
        flow: "Fiori Launchpad (Entry) → Master-Detail Search → Object Page Data Visualization → Export"
      },
      
      competitorAnalysis: {
        data: [
          { name: "Legacy SAP GUI", uxScore: 3, trustScore: 8, size: 200, fill: "#ffffff" }, 
          { name: "Oracle Financials", uxScore: 5, trustScore: 7, size: 200, fill: "#a3a3a3" }, 
          { name: "DiversityTrax", uxScore: 9, trustScore: 9, size: 400, fill: "#bef264" } 
        ],
        insights: [
          "Legacy systems require extreme cognitive load and months of specialized training.",
          "Competitors rely on fragmented UI architectures spanning multiple supplier databases.",
          "DiversityTrax unifies the experience under a single, tokenized React SPA strictly adhering to modern enterprise standards."
        ]
      },
      ...
      personas: [
        { 
          ...
          stats: [{ subject: 'Domain Lit', A: 95, fullMark: 100 }, { subject: 'Tech Savvy', A: 70, fullMark: 100 }, { subject: 'Patience', A: 30, fullMark: 100 }, { subject: 'Accuracy', A: 100, fullMark: 100 }]
        },
        { 
          name: "Operations Director", role: "Risk Mitigation", goals: ["Ensure compliance", "Audit supplier ecosystem"], 
          pains: [{label: "Data Silos", severity: 10}, {label: "Legacy UI", severity: 8}], 
          avatar: "https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=200&auto=format&fit=crop",
          stats: [{ subject: 'Domain Lit', A: 100, fullMark: 100 }, { subject: 'Tech Savvy', A: 60, fullMark: 100 }, { subject: 'Patience', A: 50, fullMark: 100 }, { subject: 'Accuracy', A: 95, fullMark: 100 }]
        }
      ],
      
      systemArchitecture: {
        client: [{name: "React 18", type: "SPA Framework"}, {name: "Fiori UI Tokens", type: "Design System"}],
        gateway: [{name: "OData Services", type: "SAP API"}, {name: "Auth0 Gateway", type: "Security"}],
        backend: [{name: "Legacy SAP HANA", type: "Data Lake"}, {name: "Node.js Middleware", type: "Aggregator"}]
      },
      
      conclusion: { 
        summary: "From initial discovery framing to final deployment, this architectural overhaul required relentless execution and strict adherence to enterprise scaling protocols. The ultimate validation was successfully onboarding a Fortune 500 enterprise client and seamlessly transitioning their entire workflow off fragmented legacy SAP GUI systems onto our unified React SPA.", 
      },
      
      styleGuide: { 
        description: "Built and governed a master Figma library mapping directly to SAP Fiori Design Guidelines (Horizon Theme), ensuring pixel-perfect translation from design to deployment for complex C-Suite analytics.",
        tokenCode: `export const fioriTokens = {\n  colors: {\n    brand: '#0a6ed1',\n    semantic: { error: '#bb0000', success: '#107e3e', warning: '#e9730c' }\n  },\n  spacing: { base: '1rem', compact: '0.5rem' }\n};`
      },
    ...
    {
      id: "03",
      title: "High-Volume Omnichannel CX",
      tag: "Omnichannel / Consumer Scale",
      role: "Lead UX Architect", // UPGRADED TITLE
      ...
      status: "Live in Production",
      heroTitle: "Omnichannel Content at Scale",
      heroSubtitle: "Algorithmic Discovery & Engagement",
      
      meta: { 
        role: "Lead UX Architect", // UPGRADED TITLE
        team: "Product, Engineering & Marketing", 
        duration: "3 Years", 
        platform: "Native iOS & Android (React Native)" 
      },
      outcomeVsOutput: { 
        output: "Native UI & Infinite Scroll Architecture.", 
        outcome: "30% engagement growth without cannibalizing retention." 
      },
      executiveSummary: "Re-architected India's highest-scaling cross-platform infrastructure to resolve severe content fatigue. Engineered a vernacular-first algorithmic discovery loop with variable-height native components and infinite scroll, driving massive omnichannel engagement.",
      impactTrend: [
        { name: 'M1', value: 12 }, { name: 'M6', value: 18 }, { name: 'M12', value: 26 }, { name: 'M24', value: 35 }
      ],
      metricsTable: [
        { metric: "Engagement Growth", before: "Baseline", after: "+30%", change: "+30%", positive: true },
        { metric: "Interaction Lift", before: "1.2%", after: "1.62%", change: "+35%", positive: true },
        { metric: "Bounce Rate", before: "65%", after: "39%", change: "-40%", positive: true }
      ],
      
      testimonials: [
        { quote: "Ajay’s strategic design approach directly amplified our omnichannel marketing ROI.", author: "Raghu", role: "Head of Marketing" },
        { quote: "Collaborating with Ajay was a masterclass in execution. He brings a rare, cross-functional perspective that bridges digital UI and monetization constraints.", author: "Krishna Chaitanya Varma", role: "Sales Leadership" }
      ],
      
      featureMatrix: [
        { feature: "Pop-up Interstitials", requestedBy: "Sales Team", status: "Rejected", rationale: "Immediate trigger for app deletion. Severe cognitive friction. Hard NO." },
        { feature: "Variable-Height Native UI", requestedBy: "UX Architecture", status: "Delivered", rationale: "Blends seamlessly into the omnichannel feed, bypassing visual blindness." }
      ],
      
      errorAudit: {
        insight: "Early builds of the infinite scroll caused massive memory leaks on low-end devices. We pivoted and strictly enforced React Native FlatList virtualization to stabilize the DOM.",
        data: [
      ...
      problemSolution: {
        problem: "Users experienced severe cognitive overload from generic content batching, leading to high bounce rates at the notification-to-app-open node.",
        friction: "Standard interstitial banners caused immediate app exits. Text density was too high for passive consumption.",
        solution: "Introduced Auto-Play Micro-Video components directly inline with the feed and designed native units mimicking organic typographic structure.",
        flow: "Personalized Push Notification → Algorithmic Sorting → Variable-Height Native Cards → Frictionless Engagement."
      },
      
      personas: [
        { 
          name: "Rural User", role: "Tier-3 Consumer", goals: ["Local content in dialect", "Low data usage"], 
          pains: [{label: "English UIs", severity: 10}, {label: "Heavy Data", severity: 9}], 
          avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=200&auto=format&fit=crop",
          stats: [{ subject: 'Domain Lit', A: 20, fullMark: 100 }, { subject: 'Tech Savvy', A: 40, fullMark: 100 }, { subject: 'Video Pref', A: 90, fullMark: 100 }, { subject: 'Sharing', A: 100, fullMark: 100 }]
        },
        { 
          ...
          stats: [{ subject: 'Domain Lit', A: 80, fullMark: 100 }, { subject: 'Tech Savvy', A: 90, fullMark: 100 }, { subject: 'Video Pref', A: 40, fullMark: 100 }, { subject: 'Sharing', A: 50, fullMark: 100 }]
        }
      ],
      
      systemArchitecture: {
        client: [{name: "React Native", type: "Mobile UI"}, {name: "Virtualization", type: "FlatList"}],
        gateway: [{name: "Content Delivery Network", type: "CDN Edge"}, {name: "GraphQL", type: "API Gateway"}],
        backend: [{name: "Recommendation Engine", type: "ML Algorithm"}, {name: "CRM Database", type: "Inventory"}]
      },
      
      conclusion: { 
        summary: "Successfully scaled enterprise engagement while massively boosting user retention. Engineered an omnichannel experience that respected severe device memory constraints while keeping millions of daily active users seamlessly engaged." 
      },
      
      styleGuide: { 
        description: "High-performance UI optimized specifically for cross-platform integration and varying vernacular typographies.",
        tokenCode: `const mobileTypography = {\n  headline: { fontFamily: 'Roboto Condensed', lineHeight: '1.2' },\n  body: { fontFamily: 'Roboto', fontSize: '16px' }\n};`
      },
  ...
  return (
    <section id="work" className="py-24 md:py-32 scroll-mt-20 relative bg-[#000000]">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 xl:px-24 relative">
        
        {/* Section Header */}
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} className="max-w-3xl">
            <span className="text-[10px] uppercase tracking-[0.4em] block mb-4 font-bold flex items-center gap-2 font-mono" style={{ color: THEME.primary }}>
              <Layers className="w-4 h-4"/> [ Architectural Deployments ]
            </span>
            <h2 className="text-[clamp(3rem,6vw,5rem)] leading-[0.85] tracking-tighter text-white font-light uppercase" style={{ fontFamily: THEME.fonts.display }}>
              PRODUCTION <br /><span className="font-bold text-transparent" style={{ WebkitTextStroke: '1px white' }}>SYSTEMS.</span>
            </h2>
          </motion.div>
        </div>
        ...
        <div className="relative pb-32 flex flex-col mt-12" role="list">
          {projectsData.map((project, i) => (
            ...
            >
              <div className="w-full max-w-[1400px] grid lg:grid-cols-12 min-h-[60vh] rounded-none overflow-hidden border border-white/10 group-hover:border-[#bef264]/40 transition-all duration-500 bg-[#0a0a0a] group-hover:shadow-[inset_0_1px_0_#bef264] group-focus-visible:ring-2 group-focus-visible:ring-[#bef264]">
                
                {/* Left Content Block */}
                <div className="lg:col-span-5 p-10 md:p-16 flex flex-col justify-between relative z-10 bg-[#0a0a0a]">
                  <div>
                    <div className="flex items-center gap-4 mb-8">
                      <span className="text-[10px] font-mono px-3 py-1 font-bold text-black" style={{ backgroundColor: THEME.primary }}>{project.id}</span>
                      <div className="w-8 h-[1px] bg-white/20" />
                      <span className="text-[10px] uppercase tracking-widest font-bold" style={{ color: THEME.muted }}>{project.year}</span>
                    </div>
                    
                    <div className="mb-6 inline-flex items-center bg-white/5 border border-white/10 px-4 py-2 rounded-sm text-white backdrop-blur-md">
                    ...
                    <h3 className="text-3xl md:text-4xl font-bold leading-tight text-white group-hover:text-[#bef264] transition-colors duration-500 mb-4" style={{ fontFamily: THEME.fonts.display }}>
                      {project.title}
                    </h3>
                    <p className="text-sm leading-relaxed font-light text-white/60 line-clamp-4 font-sans">
                  ...
                  <div className="flex items-end justify-between mt-12 border-t border-white/10 pt-6">
                    <div className="space-y-1">
                      <span className="text-[9px] uppercase tracking-widest font-bold block text-[#bef264] font-mono">{project.tag}</span>
                    </div>
                    <div className="flex items-center gap-2 group-hover:translate-x-2 transition-transform" style={{ color: THEME.primary }}>
                      <span className="text-[10px] font-bold uppercase tracking-widest font-mono">Inspect Architecture</span>
                ...
                <div className="lg:col-span-7 relative overflow-hidden hidden lg:block bg-black">
                  ...
                  <img 
                    src={project.desktopMockups?.[0] || project.mobileMocks?.[0] || project.image} 
                    className="w-full h-full object-cover grayscale opacity-30 mix-blend-luminosity group-hover:mix-blend-normal group-hover:grayscale-0 group-hover:opacity-80 transition-all duration-700 group-hover:scale-105" 
                    crossOrigin="anonymous" 
                    alt={`Preview of ${project.title} deployment`}
                    loading="lazy"
                    decoding="async"
                  />
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="relative">
                ...
                <div className="relative h-[30vh] md:h-[40vh] w-full overflow-hidden flex items-center justify-center bg-black">
                  <motion.img 
                    ...
                    src={selectedProject.desktopMockups?.[0] || selectedProject.mobileMocks?.[0] || selectedProject.image} 
                    alt={`Architecture Cover for ${selectedProject.title}`} 
                  ...
                  <button 
                    className="fixed top-6 right-6 md:top-8 md:right-8 z-[110] rounded-none bg-[#0a0a0a] border border-white/20 text-[#bef264] h-12 w-12 flex items-center justify-center transition-all duration-300 shadow-2xl hover:bg-[#bef264] hover:text-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white" 
                ...
                <div className="py-24 text-center px-6 bg-[#000000] border-t border-white/10 relative z-10">
                  <p className="text-[10px] uppercase tracking-widest mb-8 font-mono text-white/40">End of Sequence</p>
                  <button 
                    className="rounded-none px-12 h-14 border border-[#bef264] text-[10px] uppercase tracking-widest font-bold hover:scale-105 transition-all duration-300 text-[#bef264] bg-[#bef264]/10 hover:bg-[#bef264] hover:text-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white font-mono" 
                    onClick={() => setSelectedProject(null)}
...
// ============================================================================
// COMPONENT: CORE COMPETENCIES (ENTERPRISE & AI SYNCHRONIZED)
// ============================================================================

const Skills = () => {
  // 100% Synced with Factual CV Data - No Hallucinations
  const skills = [
    { 
      id: "01", 
      category: "UX Strategy & Product Design", 
      icon: <Layout className="w-5 h-5 relative z-10" />, 
      description: "Defining end-to-end product strategy for enterprise SaaS, FinTech, and GovTech platforms, balancing user needs with business goals.", 
      items: ["Enterprise SaaS", "FinTech / GovTech", "E-commerce UX"] 
    },
    { 
      id: "02", 
      category: "Complex Workflow Optimization", 
      icon: <Network className="w-5 h-5 relative z-10" />, 
      description: "Simplifying multi-tenant operational ecosystems and administrative dashboards into scalable, user-centric pathways.", 
      items: ["Workflow Design", "Interaction Design", "B2B Ecosystems"] 
    },
    { 
      id: "03", 
      category: "SAP & Legacy ERP", 
      icon: <Database className="w-5 h-5 relative z-10" />, 
      description: "Modernizing legacy SAP and CRM workflows into scalable React-based interfaces aligned strictly with SAP Fiori standards.", 
      items: ["SAP Fiori Standards", "ERP Modernization", "Procurement UX"] 
    },
    { 
      id: "04", 
      category: "Design Systems Governance", 
      icon: <Code className="w-5 h-5 relative z-10" />, 
      description: "Architecting robust UI component libraries in Figma to ensure interface consistency and seamless engineering handoffs.", 
      items: ["Design Systems", "Figma / FigJam", "UI Consistency"] 
    },
    { 
      id: "05", 
      category: "Accessibility & Standards", 
      icon: <ShieldCheck className="w-5 h-5 relative z-10" />, 
      description: "Designing accessible government and enterprise digital platforms strictly aligned with WCAG 2.2 AA standards and usability heuristics.", 
      items: ["WCAG 2.2 Standards", "Accessibility", "Responsive UI"] 
    },
    { 
      id: "06", 
      category: "Data-Driven UX Research", 
      icon: <Search className="w-5 h-5 relative z-10" />, 
      description: "Validating design decisions through continuous usability testing, platform analytics (GA4/Hotjar), and stakeholder collaboration.", 
      items: ["Usability Testing", "UX Research", "GA4 & Hotjar"] 
    }
  ];

  return (
    <section id="expertise" className="py-24 md:py-32 scroll-mt-20 px-6 md:px-12 xl:px-24 bg-[#0a0a0a] border-t border-white/5 relative overflow-hidden">
      
      {/* Ambient Blueprint Background Grid */}
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        {/* Section Header */}
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-100px" }} className="max-w-3xl">
            <span className="text-[10px] font-mono uppercase tracking-[0.4em] block mb-4 font-bold flex items-center gap-3" style={{ color: THEME.primary }}>
              <div className="flex items-center justify-center relative">
                <CheckCircle2 className="w-4 h-4 relative z-10"/>
                <div className="absolute inset-0 blur-md opacity-50 animate-pulse" style={{ backgroundColor: THEME.primary }} />
              </div>
              [ Global Standards ]
            </span>
            <h2 className="text-[clamp(3rem,6vw,5rem)] leading-[0.85] tracking-tighter text-white font-light uppercase" style={{ fontFamily: THEME.fonts.display }}>
              CORE <br /><span className="font-bold text-transparent" style={{ WebkitTextStroke: '1px white' }}>COMPETENCIES</span>
            </h2>
          </motion.div>
        </div>

        {/* Competency Matrix (Sharp Brutalist Edges) */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {skills.map((skillGroup, i) => (
            <motion.div 
              ...
              transition={{ delay: i * 0.1, duration: 0.8, ease: CUSTOM_EASE }} 
              className="group relative border border-white/10 p-8 md:p-10 flex flex-col justify-between min-h-[320px] transition-all duration-500 rounded-none bg-[#0a0a0a] hover:bg-[#111111] hover:-translate-y-2 shadow-2xl overflow-hidden"
            >
              {/* Hover Gradient Glow & Top Accent Line */}
              <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-[var(--color-primary)] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{ '--color-primary': THEME.primary } as React.CSSProperties} />
              <div className="absolute -top-24 -left-24 w-48 h-48 rounded-full blur-[100px] opacity-0 group-hover:opacity-10 transition-opacity duration-700 pointer-events-none" style={{ backgroundColor: THEME.primary }} />

              <div className="relative z-10">
                <div className="flex items-center justify-between mb-8">
                  <div className="p-3.5 rounded-sm group-hover:scale-110 transition-transform duration-300 relative shadow-[0_0_15px_rgba(0,0,0,0.5)]" style={{ backgroundColor: `${THEME.primary}15`, color: THEME.primary }}>
                    {skillGroup.icon}
                    <div className="absolute inset-0 border rounded-sm transition-colors duration-300 opacity-30 group-hover:opacity-100" style={{ borderColor: THEME.primary }} />
                  </div>
                  <span className="text-[10px] font-mono font-bold text-white/20 transition-colors duration-300" style={{ '--hover-color': THEME.primary } as any}>
              ...
              <div className="flex flex-wrap gap-2 mt-auto relative z-10 border-t border-white/5 pt-6">
                {skillGroup.items.map((item, idx) => (
                  <span 
                    key={idx} 
                    className="px-3 py-1.5 text-[9px] font-bold uppercase tracking-widest border border-white/10 rounded-none text-white/50 transition-all duration-300 bg-white/5 backdrop-blur-sm font-mono group-hover:text-white group-hover:border-white/30"
                  >
                    {item}
                  </span>
                ))}
...
const About = () => {
  return (
    <section id="philosophy" className="py-24 md:py-40 scroll-mt-20 px-6 md:px-12 xl:px-24 relative overflow-hidden bg-[#0a0a0a] border-b border-white/5">
      ...
      {/* Background Ambience (Industrial Grid) */}
      <div className="absolute inset-0 z-0 pointer-events-none opacity-20">
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff05_1px,transparent_1px),linear-gradient(to_bottom,#ffffff05_1px,transparent_1px)] bg-[size:4rem_4rem]" />
        <div className="absolute right-0 top-0 w-[800px] h-[800px] rounded-full blur-[150px] translate-x-1/3 -translate-y-1/4 opacity-30" style={{ backgroundColor: THEME.primary }} />
      </div>
      
      <div className="max-w-[1400px] mx-auto relative z-10">
        <div className="grid lg:grid-cols-[1.2fr_1fr] gap-16 lg:gap-24 items-center">
          
          {/* LEFT COLUMN: The Executive Pitch */}
          <div className="space-y-10 order-2 lg:order-1">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, ease: CUSTOM_EASE }}>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-[10px] uppercase tracking-[0.3em] font-bold" style={{ color: THEME.primary, fontFamily: THEME.fonts.mono }}>Executive Summary</span>
              </div>
              <h2 className="text-[clamp(2.5rem,5vw,4.5rem)] leading-[0.9] tracking-tighter mb-8 font-light text-white uppercase" style={{ fontFamily: THEME.fonts.display }}>
                Architecting <br /><span className="font-black">Enterprise Scale.</span>
              </h2>
              <p className="text-lg md:text-xl font-medium leading-relaxed text-white/70" style={{ fontFamily: THEME.fonts.body }}>
                I am a Senior Product Designer with 10 years of experience transforming complex B2B SaaS, FinTech, and GovTech ecosystems into scalable, user-centric platforms. I bridge the critical gap between high-level product strategy and heavy engineering execution.
              </p>
            </motion.div>

            {/* FULLY SYNCED ENTERPRISE METRICS */}
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.1, ease: CUSTOM_EASE }} className="grid grid-cols-2 md:grid-cols-3 gap-4 pt-4">
              {[ 
                ...
                { value: "B2B", label: "SaaS & FinTech" }, 
                { value: "WCAG", label: "Accessible Systems" } 
              ].map((stat, i) => (
                <div key={i} className="p-6 border border-white/10 bg-[#111] rounded-none hover:border-white/30 transition-colors shadow-lg">
                  <p className="text-3xl font-black mb-1" style={{ color: THEME.primary, fontFamily: THEME.fonts.mono }}>{stat.value}</p>
                  <p className="text-[9px] uppercase tracking-widest font-bold text-white/50">{stat.label}</p>
                </div>
              ))}
            </motion.div>

            {/* FULLY SYNCED ENTERPRISE CAPABILITIES */}
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.2, ease: CUSTOM_EASE }} className="pt-6 border-t border-white/10">
              <ul className="space-y-4">
                {[ 
                  "Designing multi-tenant enterprise platforms and administrative dashboards focused on workflow simplification.", 
                  "Modernizing legacy SAP and CRM workflows into scalable interfaces aligned with SAP Fiori standards.", 
                  "Engineering accessible GovTech and B2B systems strictly aligned with WCAG 2.2 AA guidelines." 
                ].map((item, i) => (
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 1.2, ease: CUSTOM_EASE }} className="relative group order-1 lg:order-2 max-w-md mx-auto lg:mx-0 lg:ml-auto w-full">
            ...
            {/* Hardened CSS decorators (Industrial theme) */}
            <div className="absolute -inset-4 border border-white/10 rounded-none z-0 hidden md:block" />
            <div className="absolute -inset-4 border border-transparent w-12 h-12 rounded-none z-0 hidden md:block opacity-80" style={{ borderTopColor: THEME.primary, borderLeftColor: THEME.primary }} />
            <div className="absolute -right-4 -bottom-4 border border-transparent w-12 h-12 rounded-none z-0 hidden md:block opacity-80" style={{ borderBottomColor: THEME.primary, borderRightColor: THEME.primary }} />
            ...
            <div className="aspect-[4/5] overflow-hidden border border-white/20 relative rounded-none shadow-[8px_8px_0px_0px_rgba(255,79,0,0.1)] z-10 bg-black">
              <img src="/ajay_kumar.png?q=80&w=1000&auto=format&fit=crop" alt="Ajay Kumar - Senior UI/UX & Product Designer" className="w-full h-full object-cover grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700 group-hover:scale-105" crossOrigin="anonymous" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-80" />
            </div>

            {/* Deployment HUD Overlay */}
            <div className="absolute -bottom-6 -left-6 md:-left-12 bg-[#0a0a0a] border border-white/10 p-4 rounded-none shadow-2xl z-20 flex items-center gap-4 backdrop-blur-md group-hover:-translate-y-2 transition-transform duration-500">
              <div className="w-10 h-10 rounded-full flex items-center justify-center bg-[#111] border" style={{ borderColor: `${THEME.primary}40`, color: THEME.primary }}>
                <Activity className="w-5 h-5" />
              </div>
              <div>
                <p className="text-[9px] uppercase tracking-widest font-bold text-white/50 mb-0.5">System Status</p>
                <p className="text-xs font-black text-white tracking-widest font-mono uppercase">Deployment Ready</p>
              </div>
            </div>
      ...
      <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-16 md:gap-24 items-center">
        <div className="space-y-10">
          ...
          <h2 className="text-[clamp(3.5rem,8vw,6rem)] leading-[0.9] tracking-tighter text-white" style={{ fontFamily: THEME.fonts.display }}>
            INITIATE <br /><span className="font-bold">DIALOGUE.</span>
          </h2>
          <p className="text-base md:text-lg font-light leading-relaxed max-w-md" style={{ color: THEME.muted, fontFamily: THEME.fonts.body }}>
            {/* SYNCHRONIZED ARCHITECT NARRATIVE */}
            Currently evaluating Enterprise Digital & CX Architect mandates. Available for immediate deployment into high-scale ecosystems (Onsite / Relocation Ready).
          </p>
          <div className="space-y-6 pt-4">
            
            {/* Location Node */}
            <div className="flex items-center gap-5 group w-max">
              <div className="w-12 h-12 flex items-center justify-center rounded-md transition-all bg-white/5 border border-white/10 shadow-lg">
                <MapPin className="w-4 h-4 text-white/70" />
              </div>
              <span className="text-sm font-medium text-white/80" style={{ fontFamily: THEME.fonts.body }}>
                Bengaluru, Karnataka (Open to Relocation)
              </span>
            </div>
...
export default function App() {
  ...
  return (
    // BRUTAL FIX: Removed 'cursor-none'. Native OS cursors only for Enterprise UX.
    <div className="min-h-screen selection:text-black scroll-smooth bg-[#000000]" style={{ fontFamily: THEME.fonts.body, selectionBackgroundColor: THEME.primary } as any}>
        ...
        {isLoading ? (
          ...
          <motion.div key="main-app" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, ease: CUSTOM_EASE }}>
            ...
            <main>
              ...
              {/* 2. THE EXECUTIVE SUMMARY (Moved up) */}
              <About />
              
              {/* 3. THE HARD PROOF (Case Studies) */}
              <Projects />
              
              {/* 4. THE 10-YEAR TRAJECTORY */}
              <Experience />
              
              {/* 5. THE ATS KEYWORDS (Core Competencies) */}
              <Skills />
            ...
            <footer className="py-12 border-t text-center bg-[#000000] border-white/10 text-[#a3a3a3]" style={{ fontFamily: THEME.fonts.body }}>
               <div className="max-w-[1400px] mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
                 <p className="text-[10px] uppercase tracking-widest font-bold">
                   © 2026 Ajay Kumar Myakala. Senior UX Architect.
                 </p>
                 <div className="flex items-center gap-3 text-[9px] uppercase tracking-widest font-mono text-white/30">
                   <span>System Status: Stable</span>
                   <span className="w-1 h-1 rounded-full bg-[#bef264] animate-pulse" />
                   <span>React 18 / Vercel Edge</span>
                 </div>
               </div>
            </footer>
          </motion.div>
