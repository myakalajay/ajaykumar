    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen bg-[#000000] text-white flex flex-col items-center justify-center p-6 selection:bg-[#bef264] selection:text-black">
          <div className="max-w-2xl w-full bg-white/[0.02] border border-white/10 p-12 rounded-2xl shadow-2xl relative overflow-hidden">
            
            {/* Top Accent Bar */}
            <div className="absolute top-0 left-0 w-full h-1 bg-[#bef264]" />
            
            <div className="flex items-center gap-4 mb-8">
              <div className="p-3 bg-[#bef264]/10 rounded-xl border border-[#bef264]/20 shadow-[0_0_15px_rgba(190,242,100,0.1)]">
                <AlertTriangle className="w-8 h-8 text-[#bef264]" />
              </div>
              <div>
                {/* Hooked into the Outfit display font from index.css */}
            ...
            {/* Code Output Block */}
            <div className="bg-[#0a0a0a] p-5 rounded-xl border border-white/5 mb-8 overflow-x-auto custom-scrollbar shadow-inner">
              <code className="text-[11px] leading-loose text-[#bef264] font-mono whitespace-pre-wrap">
            ...
            <button 
              ...
              className="flex items-center justify-center gap-3 w-full sm:w-auto bg-[#bef264] text-black px-8 py-4 text-xs uppercase tracking-widest font-bold hover:bg-white hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 rounded-lg shadow-[0_0_20px_rgba(190,242,100,0.2)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
            >
